...
## Readings and responses
  ...
  - Each participant in the class will write a [response](http://composition.al/CMPS290S-Fall-2018/responses.html) to each reading
  - The [readings page](http://composition.al/CMPS290S-Fall-2018/readings.html) has the current schedule of readings
