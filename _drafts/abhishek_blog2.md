...
Over the course of the two blog posts I have aimed to understand the key ideas behind early specification of operational transformation and convey it with some clarity in these posts. What I have learnt while writing these blog posts is that there are a lot of paths still left to explore and discover. 