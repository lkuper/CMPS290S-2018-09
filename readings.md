...
| Monday, 12/3     | Abstractions for configuration management **(be done with a draft of your second blog post and soliciting editor/instructor feedback by today)** | Aldrin              | Sameer Ajmani, Barbara Liskov, and Liuba Shrira, [Modular Software Upgrades for Distributed Systems (ECOOP '06)](http://pmg.csail.mit.edu/pubs/ajmani06modular-abstract.html)
