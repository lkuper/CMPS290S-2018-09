...
| Friday, 10/19    | Consistency models: "causal+" consistency    |                      | [Don't Settle for Eventual: Scalable Causal Consistency for Wide-Area Storage with COPS (SOSP '11)](https://www.cs.cmu.edu/~dga/papers/cops-sosp2011.pdf)
...
| Wednesday, 10/24 | Consistency models: surveys and overviews    |                      | [Consistency, Availability, and Convergence (2011)](http://www.cs.cornell.edu/lorenzo/papers/cac-tr.pdf)
...
| Wednesday, 10/31 | Replicated data types: CRDTs                 |                      | [A comprehensive study of Convergent and Commutative Replicated Data Types (2011)](https://hal.inria.fr/inria-00555588/document)
| Friday, 11/2     | Replicated data types: Cloud types           |                      | [Cloud Types for Eventual Consistency (ECOOP '12)](https://www.microsoft.com/en-us/research/wp-content/uploads/2016/02/CloudTypes-ECOOP12.pdf) (see also: Burckhardt's book, [_Principles of Eventual Consistency_](https://www.microsoft.com/en-us/research/wp-content/uploads/2016/02/final-printversion-10-5-14.pdf))
| Monday, 10/29    | Mixed consistency: a systems perspective     |                      | [Consistency-based service level agreements for cloud storage (SOSP '13)](https://www.microsoft.com/en-us/research/publication/consistency-based-service-level-agreements-for-cloud-storage/)
| Wednesday, 10/31 | Mixed consistency: a PL perspective          |                      | ['Cause I'm Strong Enough: Reasoning About Consistency Choices in Distributed Systems (POPL '16)](http://software.imdea.org/~gotsman/papers/logic-popl16.pdf)
| Friday, 11/2     | Mixed consistency: another PL perspective    |                      | [MixT: a Language for Mixing Consistency in Geodistributed Transactions (PLDI '18)](http://www.cs.cornell.edu/andru/papers/mixt/mixt.pdf)
| Monday, 11/5     | Verifying consistency                        |                      | [Chapar: Certified Causally Consistent Distributed Key-Value Stores (POPL '16)](http://www.cs.ucr.edu/~lesani/companion/popl16/POPL16.pdf)
...
| Wednesday, 11/28 | Languages and frameworks for distribution    |                      | [P: Safe Asynchronous Event-Driven Programming (PLDI '13)](https://dl.acm.org/citation.cfm?id=2462184) (see also: [P on GitHub](https://github.com/p-org/P))
| Friday, 11/30    | Languages and frameworks for distribution    |                      | [Compositional Programming and Testing of Dynamic Distributed Systems (OOPSLA '18)](https://2018.splashcon.org/event/splash-2018-oopsla-compositional-programming-and-testing-of-dynamic-distributed-systems) (TODO: update with correct paper link)
...
## To add somewhere
  ...
  - [Disciplined Inconsistency with Consistency Types (SoCC '16)](http://bholt.org/gen/ipa.pdf)
