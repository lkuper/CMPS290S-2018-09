...
| Wednesday, 11/28 | Languages and frameworks for distribution **(aim to be nearly done with the second of your two blog posts and soliciting editor/instructor feedback by today)**  |                      | Sebastian Burckhardt and Tim Coppieters, [Reactive Caching for Composed Services: Polling at the Speed of Push (OOPSLA '18)](https://2018.splashcon.org/event/splash-2018-oopsla-reactive-caching-for-composed-services) (TODO: update with correct paper link)
